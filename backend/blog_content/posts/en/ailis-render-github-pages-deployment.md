# How AILIS Is Deployed: GitHub Pages for the Frontend and Render for the Backend

AILIS is no longer only a local virtual-character demo. It has been split into a deployable web system: the frontend runs on GitHub Pages, the backend runs on Render, and visitors can open a browser to meet AILIS and try the conversation flow.
...
- Full live experience: [https://haowenGuo.github.io/AILIS/?backend=https://airi-backend.onrender.com](https://haowenGuo.github.io/AILIS/?backend=https://airi-backend.onrender.com)
- Frontend-only page: [https://haowenGuo.github.io/AILIS/](https://haowenGuo.github.io/AILIS/)
...
The AILIS backend is not just a thin proxy.
...
AILIS is not organized around a plain chat box. It is organized around the AILIS avatar:
...
[https://github.com/haowenGuo/AILIS](https://github.com/haowenGuo/AILIS)
...
AILIS is no longer just “something that runs on my machine.” It becomes:
...
The current deployment is not complicated, but it changes AILIS from a local AI avatar experiment into something people can open, experience, understand, and follow.
