...
- `backend/blog_content/authoring_kit/post_template_zh.md`
- `backend/blog_content/authoring_kit/post_template_en.md`
- `backend/blog_content/authoring_kit/posts_json_entry_template.json`
