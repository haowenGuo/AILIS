...
const DEFAULT_DESKTOP_SPEECH_MODE = 'hosted';
...
const DEFAULT_WEB_SERVER_TTS_TIMEOUT_MS = 12000;
...
export const CONFIG = {
    ...
    SPEAK_SPEED: 5.2,
    SPEAK_AMPLITUDE: 0.76,
    MAX_MOUTH_OPEN: 0.86,
    LIP_SYNC_SMOOTHING: 0.32,
    AUDIO_LIP_SYNC_MODEL_SMOOTHING: 0.8,
    AUDIO_LIP_SYNC_ANALYSER_SMOOTHING: 0.12,
    AUDIO_LIP_SYNC_NOISE_FLOOR: 0.012,
    AUDIO_LIP_SYNC_GAIN: 12,
    AUDIO_LIP_SYNC_ATTACK: 0.68,
    AUDIO_LIP_SYNC_RELEASE: 0.28,
    AUDIO_LIP_SYNC_SILENCE_THRESHOLD: 0.03,
    AUDIO_LIP_SYNC_RESPONSE_CURVE: 0.48,
    AUDIO_LIP_SYNC_MIN_CADENCE: 4.8,
    AUDIO_LIP_SYNC_MAX_CADENCE: 7,
    AUDIO_LIP_SYNC_SUSTAIN: 0.16,
    AUDIO_LIP_SYNC_PULSE_SHAPE: 1.05,
    AUDIO_LIP_SYNC_BOOST: 1.08,
    ...
    WEB_SERVER_TTS_TIMEOUT_MS: DEFAULT_WEB_SERVER_TTS_TIMEOUT_MS,
