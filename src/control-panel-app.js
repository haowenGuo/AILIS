...
function renderCharacterRendererStatus() {
    if (elements.characterRendererStatus) {
        elements.characterRendererStatus.textContent = 'Electron / Three.js';
    }
}
...
async function initialize() {
    ...
    try {
        ...
        if (bootstrapPreferences && Object.keys(bootstrapPreferences).length) {            fillForm(bootstrapPreferences);
        }
