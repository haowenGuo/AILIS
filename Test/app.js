...
const LEGACY_TTS_VOICE_STORAGE_KEY = 'ailis.web.tts-voice.v1';
...
function clearLegacyTtsVoiceSelection() {
    try {
        window.localStorage?.removeItem(LEGACY_TTS_VOICE_STORAGE_KEY);
    } catch {
