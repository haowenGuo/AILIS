...
AILIS uses a lightweight core installer plus optional runtime packs. The default release does not bundle large local models, Python environments, CosyVoice3, ASR, or Web/Search runtimes into the core installer.
