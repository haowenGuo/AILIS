# AILIS Codex-Aligned Skill and MCP Reference

Last updated: 2026-06-05

This document is the working reference for aligning AILIS's Skill and MCP layers with the local Codex implementation. It is intentionally source-backed: every architectural claim below points to local Codex source files under `F:\AILIS\build-cache\codex-runtime`, with short code excerpts and AILIS-side mapping notes.
...
| Layer | Codex role | Executes work | AILIS target |
|---|---|---:|---|
...
AILIS should keep the same engineering pattern, then add the embodied/persona surface above the final user-facing output.
...
- `F:\AILIS\build-cache\codex-runtime\codex-rs\core-skills\src\render.rs`
- `F:\AILIS\build-cache\codex-runtime\codex-rs\core-skills\src\loader.rs`
...
- `F:\AILIS\build-cache\codex-runtime\codex-rs\core-skills\src\render.rs:31`
- `F:\AILIS\build-cache\codex-runtime\codex-rs\core-skills\src\render.rs:33`
- `F:\AILIS\build-cache\codex-runtime\codex-rs\core-skills\src\render.rs:34`
...
- AILIS skills should become packages:
...
- `F:\AILIS\build-cache\codex-runtime\codex-rs\core-skills\src\loader.rs:704`
- `F:\AILIS\build-cache\codex-runtime\codex-rs\core-skills\src\loader.rs:705`
- `F:\AILIS\build-cache\codex-runtime\codex-rs\core-skills\src\loader.rs:760`
...
- `F:\AILIS\build-cache\codex-runtime\codex-rs\config\src\mcp_types.rs:425`
- `F:\AILIS\build-cache\codex-runtime\codex-rs\config\src\mcp_types.rs:438`
...
- AILIS already has stdio and HTTP MCP support through `mcp_bridge`.
- AILIS's local research server is `F:\AILIS\scripts\mcp-ailis-research-server.cjs`.

AILIS adjustment rule:

- Treat MCP as a Host-owned connection registry.
- Store transport config in an AILIS-local config directory under the app root, not scattered ad hoc.
...
- `F:\AILIS\build-cache\codex-runtime\codex-rs\codex-mcp\src\connection_manager.rs:372`
...
- Example target: expose `mcp__ailis_research__web_fetch(url)` as the canonical model-facing id, while still accepting legacy `mcp:ailis_research:web_fetch` as a compatibility alias, instead of asking the model to call `mcp_bridge.call_tool(server, tool, args)`.
...
- `F:\AILIS\build-cache\codex-runtime\codex-rs\core\src\tools\handlers\mcp.rs:36`
...
```json
{
  ...
  "legacy_id": "mcp:ailis_research:web_fetch",
...
- `F:\AILIS\build-cache\codex-runtime\codex-rs\core\src\mcp_tool_exposure.rs:13`
- `F:\AILIS\build-cache\codex-runtime\codex-rs\core\src\mcp_tool_exposure.rs:14`
- `F:\AILIS\build-cache\codex-runtime\codex-rs\core\src\mcp_tool_exposure.rs:36`
...
- `F:\AILIS\build-cache\codex-runtime\codex-rs\core\src\tools\handlers\tool_search_spec.rs:50`
...
- `F:\AILIS\build-cache\codex-runtime\codex-rs\core\src\session\turn.rs:170`
- `F:\AILIS\build-cache\codex-runtime\codex-rs\core\src\session\turn.rs:457`
- `F:\AILIS\build-cache\codex-runtime\codex-rs\core\src\session\turn.rs:1059`
- `F:\AILIS\build-cache\codex-runtime\codex-rs\core\src\session\turn.rs:1121`
...
- `F:\AILIS\build-cache\codex-runtime\codex-rs\core-plugins\src\manifest.rs:26`
- `F:\AILIS\build-cache\codex-runtime\codex-rs\core-plugins\src\manifest.rs:28`
- `F:\AILIS\build-cache\codex-runtime\codex-rs\core-plugins\src\manifest.rs:48`
- `F:\AILIS\build-cache\codex-runtime\codex-rs\core-plugins\src\manifest.rs:50`
...
- AILIS capability installer should install bundles, not just random tools:
...
- `F:\AILIS\build-cache\codex-runtime\codex-rs\core-plugins\src\loader.rs:47`
- `F:\AILIS\build-cache\codex-runtime\codex-rs\core-plugins\src\loader.rs:49`
- `F:\AILIS\build-cache\codex-runtime\codex-rs\core-plugins\src\loader.rs:567`
- `F:\AILIS\build-cache\codex-runtime\codex-rs\core-plugins\src\loader.rs:580`
- `F:\AILIS\build-cache\codex-runtime\codex-rs\core-plugins\src\loader.rs:996`
...
- Make AILIS capabilities installable in the same structure.
...
- `F:\AILIS\build-cache\codex-runtime\codex-rs\core\src\tools\handlers\mcp.rs:229`
- `F:\AILIS\build-cache\codex-runtime\codex-rs\core\src\tools\handlers\mcp.rs:191`
...
- Import MCP `inputSchema` into AILIS's tool registry.
...
## 8. AILIS Current State vs Codex Reference

| Area | AILIS today | Codex reference | Alignment target |
|---|---|---|---|
...
## 9. Concrete AILIS Refactor Plan
...
- Normalize each into AILIS internal tool spec.
...
- Model sees `ailis_research.web_fetch(url)` or equivalent.
...
## 10. Design Rules for Future AILIS Changes
...
- Model then called `ailis_research.web_fetch` with `targets`, but schema required `url`.
...
- `F:\AILIS\build-cache\codex-runtime\codex-rs\core-skills\src\render.rs`
- `F:\AILIS\build-cache\codex-runtime\codex-rs\core-skills\src\loader.rs`
- `F:\AILIS\build-cache\codex-runtime\codex-rs\core-skills\src\model.rs`
- `F:\AILIS\build-cache\codex-runtime\codex-rs\core-skills\src\injection.rs`
- `F:\AILIS\build-cache\codex-runtime\codex-rs\core-skills\src\manager.rs`

Codex MCP sources:

- `F:\AILIS\build-cache\codex-runtime\codex-rs\codex-mcp\src\connection_manager.rs`
- `F:\AILIS\build-cache\codex-runtime\codex-rs\codex-mcp\src\mcp\mod.rs`
- `F:\AILIS\build-cache\codex-runtime\codex-rs\config\src\mcp_types.rs`
- `F:\AILIS\build-cache\codex-runtime\codex-rs\core\src\tools\handlers\mcp.rs`
- `F:\AILIS\build-cache\codex-runtime\codex-rs\core\src\mcp_tool_exposure.rs`
- `F:\AILIS\build-cache\codex-runtime\codex-rs\core\src\tools\handlers\tool_search.rs`
- `F:\AILIS\build-cache\codex-runtime\codex-rs\core\src\tools\handlers\tool_search_spec.rs`
- `F:\AILIS\build-cache\codex-runtime\codex-rs\core\src\session\turn.rs`

Codex Plugin sources:

- `F:\AILIS\build-cache\codex-runtime\codex-rs\core-plugins\src\manifest.rs`
- `F:\AILIS\build-cache\codex-runtime\codex-rs\core-plugins\src\loader.rs`
