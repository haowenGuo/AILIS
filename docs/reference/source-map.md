...
本手册的运行时核对基线为提交 2f2c9e45145d935279b841b5d82ac7d36a0d5222，核对日期为 2026-09-06；后续 v1.4.2 将统一 Agent、生产构建及桌面体验改动整合发布，参见[版本说明](../releases/v1.4.2.md)。安装实例应通过 Release manifest 的版本、源码提交和 SHA256SUMS 核验，不能仅依据主线文档判断。历史 v1.4.1 安装包来自 659bf61，历史内容可从版本标签与 Git 提交查阅。
