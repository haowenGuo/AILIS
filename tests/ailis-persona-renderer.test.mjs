...
const {
    ...
    renderStatusSurface
} = require('../electron/ailis-persona-renderer.cjs');

test('AILIS persona renderer turns tool approval into embodied user-facing surface', () => {
    ...
    assert.equal(surface.renderer, 'ailis-persona-renderer');
...
test('AILIS persona renderer attaches structured surface while preserving agent status', () => {
...
test('AILIS persona renderer reads tool experience metadata from contracts', () => {
