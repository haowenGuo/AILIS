...
const { executeReadXlsxWorkbookTool } = require('../electron/humanclaw-xlsx-workbook-tool.cjs');
const { HumanClawContextArtifactStore } = require('../electron/humanclaw-context-artifact-store.cjs');
...
test('read_xlsx_workbook reads values, fills, formulas, and merged ranges', async () => {
    ...
    const contextArtifactStore = new HumanClawContextArtifactStore({
