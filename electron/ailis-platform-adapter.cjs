...
function createAILISPlatformAdapter(options = {}) {
    if (options instanceof AILISPlatformAdapter) {
        return options;
    }
    if (typeof options === 'string') {
        return new AILISPlatformAdapter({ platform: options });
    }
    return new AILISPlatformAdapter(options);
}

function getDefaultPlatformAdapter() {
    if (!defaultAdapter) {
        defaultAdapter = createAILISPlatformAdapter();
    }
