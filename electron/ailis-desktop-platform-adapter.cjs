...
class AILISDesktopPlatformAdapter {
    constructor(options = {}) {
...
function createAILISDesktopPlatformAdapter(options = {}) {
    if (options instanceof AILISDesktopPlatformAdapter) {
        return options;
    }
    return new AILISDesktopPlatformAdapter(options);
}

module.exports = {
    AILISDesktopPlatformAdapter,
