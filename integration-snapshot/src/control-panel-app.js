...
const elements = {
    ...
    memoryStrategySelect: document.getElementById('memory-strategy-select'),
    memoryStrategyStatusText: document.getElementById('memory-strategy-status-text'),
    curateMemoryCognitionBtn: document.getElementById('curate-memory-cognition-btn'),
    ...
    openCharacterLabBtn: document.getElementById('open-character-lab-btn'),
    autoChatMode: document.getElementById('auto-chat-mode'),
    characterRendererBackend: document.getElementById('character-renderer-backend'),
    characterRendererStatus: document.getElementById('character-renderer-status'),
    electronRenderSettings: document.getElementById('electron-render-settings'),
    unityRendererSettings: document.getElementById('unity-renderer-settings'),
    unityPipelineAsset: document.getElementById('unity-pipeline-asset'),
    unityTargetFrameRate: document.getElementById('unity-target-frame-rate'),
    unityRenderScale: document.getElementById('unity-render-scale'),
    unityRenderScaleValue: document.getElementById('unity-render-scale-value'),
    unityMsaaSampleCount: document.getElementById('unity-msaa-sample-count'),
    unityAdaptiveSupersampling: document.getElementById('unity-adaptive-supersampling'),
    unityShadowDistance: document.getElementById('unity-shadow-distance'),
    unityShadowDistanceValue: document.getElementById('unity-shadow-distance-value'),
    unityShadowCascadeCount: document.getElementById('unity-shadow-cascade-count'),
    unityCameraAntialiasing: document.getElementById('unity-camera-antialiasing'),
    unityCameraAntialiasingQuality: document.getElementById('unity-camera-antialiasing-quality'),
    unityRenderPostProcessing: document.getElementById('unity-render-post-processing'),
    unityPostExposure: document.getElementById('unity-post-exposure'),
    unityPostExposureValue: document.getElementById('unity-post-exposure-value'),
    unityContrast: document.getElementById('unity-contrast'),
    unityContrastValue: document.getElementById('unity-contrast-value'),
    unitySaturation: document.getElementById('unity-saturation'),
    unitySaturationValue: document.getElementById('unity-saturation-value'),
    unityBloomIntensity: document.getElementById('unity-bloom-intensity'),
    unityBloomIntensityValue: document.getElementById('unity-bloom-intensity-value'),
    unityMtoonOutlineWidth: document.getElementById('unity-mtoon-outline-width'),
    unityMtoonOutlineWidthValue: document.getElementById('unity-mtoon-outline-width-value'),
    unityMtoonOutlineColorBlend: document.getElementById('unity-mtoon-outline-color-blend'),
    unityMtoonOutlineColorBlendValue: document.getElementById('unity-mtoon-outline-color-blend-value'),
    unityCameraFramingMode: document.getElementById('unity-camera-framing-mode'),
    unityCameraFov: document.getElementById('unity-camera-fov'),
    unityCameraFovValue: document.getElementById('unity-camera-fov-value'),
    unityCameraDistance: document.getElementById('unity-camera-distance'),
    unityCameraDistanceValue: document.getElementById('unity-camera-distance-value'),
    unityCameraHeight: document.getElementById('unity-camera-height'),
    unityCameraHeightValue: document.getElementById('unity-camera-height-value'),
    unityCameraTargetHeight: document.getElementById('unity-camera-target-height'),
    unityCameraTargetHeightValue: document.getElementById('unity-camera-target-height-value'),
    unityCameraHorizontalOffset: document.getElementById('unity-camera-horizontal-offset'),
    unityCameraHorizontalOffsetValue: document.getElementById('unity-camera-horizontal-offset-value'),
    unityFramingPadding: document.getElementById('unity-framing-padding'),
    unityFramingPaddingValue: document.getElementById('unity-framing-padding-value'),
    unityFramingVerticalBias: document.getElementById('unity-framing-vertical-bias'),
    unityFramingVerticalBiasValue: document.getElementById('unity-framing-vertical-bias-value'),
    unityAmbientIntensity: document.getElementById('unity-ambient-intensity'),
    unityAmbientIntensityValue: document.getElementById('unity-ambient-intensity-value'),
    unityMainLightShadows: document.getElementById('unity-main-light-shadows'),
    unityMainLightShadowStrength: document.getElementById('unity-main-light-shadow-strength'),
    unityMainLightShadowStrengthValue: document.getElementById('unity-main-light-shadow-strength-value'),
    unityKeyLightIntensity: document.getElementById('unity-key-light-intensity'),
    unityKeyLightIntensityValue: document.getElementById('unity-key-light-intensity-value'),
    unityKeyLightYaw: document.getElementById('unity-key-light-yaw'),
    unityKeyLightYawValue: document.getElementById('unity-key-light-yaw-value'),
    unityKeyLightPitch: document.getElementById('unity-key-light-pitch'),
    unityKeyLightPitchValue: document.getElementById('unity-key-light-pitch-value'),
    unityKeyLightColor: document.getElementById('unity-key-light-color'),
    unityFillLightIntensity: document.getElementById('unity-fill-light-intensity'),
    unityFillLightIntensityValue: document.getElementById('unity-fill-light-intensity-value'),
    unityFillLightColor: document.getElementById('unity-fill-light-color'),
    unityRimLightIntensity: document.getElementById('unity-rim-light-intensity'),
    unityRimLightIntensityValue: document.getElementById('unity-rim-light-intensity-value'),
    unityRimLightColor: document.getElementById('unity-rim-light-color'),
...
const DEFAULT_UNITY_RENDERER_SETTINGS = Object.freeze({
    ...
    cameraAntialiasing: 'none',
    cameraAntialiasingQuality: 'medium',
    renderPostProcessing: false,
    postExposure: 0,
    contrast: 0,
    saturation: 0,
    bloomIntensity: 0,
    mtoonOutlineWidthMultiplier: 0.75,
    mtoonOutlineColorBlend: 0.58,
    cameraFramingMode: 'full-body',
    cameraFieldOfView: 38,
    cameraDistance: 2.15,
    cameraHeight: 1.3,
    cameraTargetHeight: 1.18,
    cameraHorizontalOffset: 0,
    framingPadding: 1.14,
    framingVerticalBias: 0.02,
    ambientIntensity: 1.05,
    mainLightShadows: true,
    mainLightShadowStrength: 0.45,
    keyLightIntensity: 1.1,
    keyLightYaw: 160,
    keyLightPitch: 30,
    keyLightColor: '#FFF2E8',
    fillLightIntensity: 0.78,
    fillLightColor: '#E8EEFF',
    rimLightIntensity: 0.58,
    rimLightColor: '#CFE7FF'
});

const UNITY_RENDER_PRESETS = Object.freeze({
...
function normalizeUnityRendererSettings(value = {}) {
    const input = value && typeof value === 'object' ? value : {};
    const defaults = DEFAULT_UNITY_RENDERER_SETTINGS;
    const option = (candidate, values, fallback) => {
    ...
    const requestedMsaa = Math.round(Number(input.msaaSampleCount ?? input.antiAliasing));
    const legacyPipelineAsset = input.pipelineAsset || input.qualityPreset;
    const legacyShadowEnabled = String(input.shadowQuality || '').trim().toLowerCase() !== 'off';
    const pipelineAsset = option(
        legacyPipelineAsset,
        ['performance', 'balanced', 'quality'],
        defaults.pipelineAsset
    );
    const legacyPerformancePreset = Number(input.performanceTuningVersion || 0) < 2 &&
        pipelineAsset === 'performance' &&
        Number(input.targetFrameRate) === 30 &&
        Number(input.renderScale) === 0.85 &&
        requestedMsaa === 2;
    return {
        performanceTuningVersion: 2,
        pipelineAsset,
        targetFrameRate: legacyPerformancePreset
            ? 60
            : Math.round(clampNumber(input.targetFrameRate, 24, 240, defaults.targetFrameRate, 0)),
        renderScale: clampNumber(input.renderScale, 0.5, 2, defaults.renderScale, 2),
        msaaSampleCount: [1, 2, 4, 8].includes(requestedMsaa) ? requestedMsaa : defaults.msaaSampleCount,
        adaptiveSupersampling: input.adaptiveSupersampling !== false,
        shadowDistance: clampNumber(input.shadowDistance, 0, 100, defaults.shadowDistance, 1),
        shadowCascadeCount: Math.round(clampNumber(input.shadowCascadeCount, 1, 4, defaults.shadowCascadeCount, 0)),
        cameraAntialiasing: option(input.cameraAntialiasing, ['none', 'fxaa', 'smaa'], defaults.cameraAntialiasing),
        cameraAntialiasingQuality: option(input.cameraAntialiasingQuality, ['low', 'medium', 'high'], defaults.cameraAntialiasingQuality),
        renderPostProcessing: input.renderPostProcessing === true,
        postExposure: clampNumber(input.postExposure, -5, 5, defaults.postExposure, 2),
        contrast: clampNumber(input.contrast, -100, 100, defaults.contrast, 0),
        saturation: clampNumber(input.saturation, -100, 100, defaults.saturation, 0),
        bloomIntensity: clampNumber(input.bloomIntensity, 0, 10, defaults.bloomIntensity, 2),
        mtoonOutlineWidthMultiplier: clampNumber(
            input.mtoonOutlineWidthMultiplier,
            0,
            1.5,
            defaults.mtoonOutlineWidthMultiplier,
            2
        ),
        mtoonOutlineColorBlend: clampNumber(
            input.mtoonOutlineColorBlend,
            0,
            1,
            defaults.mtoonOutlineColorBlend,
            2
        ),
        cameraFramingMode: option(input.cameraFramingMode, ['full-body', 'manual'], defaults.cameraFramingMode),
        cameraFieldOfView: clampNumber(input.cameraFieldOfView, 20, 70, defaults.cameraFieldOfView, 1),
        cameraDistance: clampNumber(input.cameraDistance, 0.8, 5, defaults.cameraDistance, 2),
        cameraHeight: clampNumber(input.cameraHeight, 0.2, 3.5, defaults.cameraHeight, 2),
        cameraTargetHeight: clampNumber(input.cameraTargetHeight, 0.1, 3, defaults.cameraTargetHeight, 2),
        cameraHorizontalOffset: clampNumber(input.cameraHorizontalOffset, -1.5, 1.5, defaults.cameraHorizontalOffset, 2),
        framingPadding: clampNumber(input.framingPadding, 1.01, 2, defaults.framingPadding, 2),
        framingVerticalBias: clampNumber(input.framingVerticalBias, -0.5, 0.5, defaults.framingVerticalBias, 2),
        ambientIntensity: clampNumber(input.ambientIntensity, 0, 2, defaults.ambientIntensity, 2),
        mainLightShadows: input.mainLightShadows === undefined
            ? (input.shadowQuality === undefined ? defaults.mainLightShadows : legacyShadowEnabled)
            : input.mainLightShadows !== false,
        mainLightShadowStrength: clampNumber(
            input.mainLightShadowStrength ?? input.shadowStrength,
            0,
            1,
            defaults.mainLightShadowStrength,
            2
        ),
        keyLightIntensity: clampNumber(input.keyLightIntensity, 0, 3, defaults.keyLightIntensity, 2),
        keyLightYaw: clampNumber(input.keyLightYaw, -180, 180, defaults.keyLightYaw, 0),
        keyLightPitch: clampNumber(input.keyLightPitch, -10, 85, defaults.keyLightPitch, 0),
        keyLightColor: color(input.keyLightColor, defaults.keyLightColor),
        fillLightIntensity: clampNumber(input.fillLightIntensity, 0, 2, defaults.fillLightIntensity, 2),
        fillLightColor: color(input.fillLightColor, defaults.fillLightColor),
        rimLightIntensity: clampNumber(input.rimLightIntensity, 0, 2, defaults.rimLightIntensity, 2),
        rimLightColor: color(input.rimLightColor, defaults.rimLightColor)
    };
}

function syncRendererBackendPanels() {
    const useUnity = availableCharacterRendererBackends.includes('unity') &&
        (elements.characterRendererBackend?.value || currentPreferences?.characterRendererBackend) === 'unity';
    if (elements.electronRenderSettings) {
        elements.electronRenderSettings.hidden = useUnity;
    }
    if (elements.unityRendererSettings) {
        elements.unityRendererSettings.hidden = !useUnity;
    }
}

function renderCharacterRendererStatus(runtime = {}, backend = 'electron') {
    if (!elements.characterRendererStatus) {
        return;
    }
    if (backend !== 'unity') {
        elements.characterRendererStatus.textContent =
            availableCharacterRendererBackends.includes('unity')
                ? '当前使用 Electron / Three.js；可随时切换到 AIGAME 的 Unity 高清渲染。'
                : '当前使用 Electron / Three.js 轻量渲染。';
        return;
    }
    const status = String(runtime.status || 'not_started');
    if (status === 'ready') {
        elements.characterRendererStatus.textContent =
            'Unity 高清渲染正在运行；聊天、语音和 Agent 仍由原 Electron 运行时承载。';
        return;
    }
    if (status === 'starting') {
        elements.characterRendererStatus.textContent =
            'Unity 正在启动，完成前继续显示 Electron 人物，避免桌宠空白。';
        return;
    }
    if (runtime.error) {
        elements.characterRendererStatus.textContent =
            `Unity 暂不可用，已自动回退 Electron：${runtime.error}`;
        return;
    }
    elements.characterRendererStatus.textContent = runtime.available === false
        ? '未找到 Unity 渲染组件，当前会自动使用 Electron。'
        : '保存后将启动 Unity；如果启动失败会自动回退 Electron。';
}
...
let panelState = null;
let availableCharacterRendererBackends = ['electron'];
...
function readUnityRendererForm() {
    return normalizeUnityRendererSettings({
        pipelineAsset: elements.unityPipelineAsset?.value,
        targetFrameRate: elements.unityTargetFrameRate?.value,
        renderScale: elements.unityRenderScale?.value,
        msaaSampleCount: elements.unityMsaaSampleCount?.value,
        adaptiveSupersampling: elements.unityAdaptiveSupersampling?.checked,
        shadowDistance: elements.unityShadowDistance?.value,
        shadowCascadeCount: elements.unityShadowCascadeCount?.value,
        cameraAntialiasing: elements.unityCameraAntialiasing?.value,
        cameraAntialiasingQuality: elements.unityCameraAntialiasingQuality?.value,
        renderPostProcessing: elements.unityRenderPostProcessing?.checked,
        postExposure: elements.unityPostExposure?.value,
        contrast: elements.unityContrast?.value,
        saturation: elements.unitySaturation?.value,
        bloomIntensity: elements.unityBloomIntensity?.value,
        mtoonOutlineWidthMultiplier: elements.unityMtoonOutlineWidth?.value,
        mtoonOutlineColorBlend: elements.unityMtoonOutlineColorBlend?.value,
        cameraFramingMode: elements.unityCameraFramingMode?.value,
        cameraFieldOfView: elements.unityCameraFov?.value,
        cameraDistance: elements.unityCameraDistance?.value,
        cameraHeight: elements.unityCameraHeight?.value,
        cameraTargetHeight: elements.unityCameraTargetHeight?.value,
        cameraHorizontalOffset: elements.unityCameraHorizontalOffset?.value,
        framingPadding: elements.unityFramingPadding?.value,
        framingVerticalBias: elements.unityFramingVerticalBias?.value,
        ambientIntensity: elements.unityAmbientIntensity?.value,
        mainLightShadows: elements.unityMainLightShadows?.checked,
        mainLightShadowStrength: elements.unityMainLightShadowStrength?.value,
        keyLightIntensity: elements.unityKeyLightIntensity?.value,
        keyLightYaw: elements.unityKeyLightYaw?.value,
        keyLightPitch: elements.unityKeyLightPitch?.value,
        keyLightColor: elements.unityKeyLightColor?.value,
        fillLightIntensity: elements.unityFillLightIntensity?.value,
        fillLightColor: elements.unityFillLightColor?.value,
        rimLightIntensity: elements.unityRimLightIntensity?.value,
        rimLightColor: elements.unityRimLightColor?.value
    });
}

function writeUnityRendererForm(settings = {}) {
    const normalized = normalizeUnityRendererSettings(settings);
    const assignValue = (element, value) => {
        if (element) element.value = String(value);
    };
    assignValue(elements.unityPipelineAsset, normalized.pipelineAsset);
    assignValue(elements.unityTargetFrameRate, normalized.targetFrameRate);
    assignValue(elements.unityRenderScale, normalized.renderScale);
    assignValue(elements.unityMsaaSampleCount, normalized.msaaSampleCount);
    if (elements.unityAdaptiveSupersampling) {
        elements.unityAdaptiveSupersampling.checked = normalized.adaptiveSupersampling;
    }
    assignValue(elements.unityShadowDistance, normalized.shadowDistance);
    assignValue(elements.unityShadowCascadeCount, normalized.shadowCascadeCount);
    assignValue(elements.unityCameraAntialiasing, normalized.cameraAntialiasing);
    assignValue(elements.unityCameraAntialiasingQuality, normalized.cameraAntialiasingQuality);
    if (elements.unityRenderPostProcessing) {
        elements.unityRenderPostProcessing.checked = normalized.renderPostProcessing;
    }
    assignValue(elements.unityPostExposure, normalized.postExposure);
    assignValue(elements.unityContrast, normalized.contrast);
    assignValue(elements.unitySaturation, normalized.saturation);
    assignValue(elements.unityBloomIntensity, normalized.bloomIntensity);
    assignValue(elements.unityMtoonOutlineWidth, normalized.mtoonOutlineWidthMultiplier);
    assignValue(elements.unityMtoonOutlineColorBlend, normalized.mtoonOutlineColorBlend);
    assignValue(elements.unityCameraFramingMode, normalized.cameraFramingMode);
    assignValue(elements.unityCameraFov, normalized.cameraFieldOfView);
    assignValue(elements.unityCameraDistance, normalized.cameraDistance);
    assignValue(elements.unityCameraHeight, normalized.cameraHeight);
    assignValue(elements.unityCameraTargetHeight, normalized.cameraTargetHeight);
    assignValue(elements.unityCameraHorizontalOffset, normalized.cameraHorizontalOffset);
    assignValue(elements.unityFramingPadding, normalized.framingPadding);
    assignValue(elements.unityFramingVerticalBias, normalized.framingVerticalBias);
    assignValue(elements.unityAmbientIntensity, normalized.ambientIntensity);
    if (elements.unityMainLightShadows) {
        elements.unityMainLightShadows.checked = normalized.mainLightShadows;
    }
    assignValue(elements.unityMainLightShadowStrength, normalized.mainLightShadowStrength);
    assignValue(elements.unityKeyLightIntensity, normalized.keyLightIntensity);
    assignValue(elements.unityKeyLightYaw, normalized.keyLightYaw);
    assignValue(elements.unityKeyLightPitch, normalized.keyLightPitch);
    assignValue(elements.unityKeyLightColor, normalized.keyLightColor);
    assignValue(elements.unityFillLightIntensity, normalized.fillLightIntensity);
    assignValue(elements.unityFillLightColor, normalized.fillLightColor);
    assignValue(elements.unityRimLightIntensity, normalized.rimLightIntensity);
    assignValue(elements.unityRimLightColor, normalized.rimLightColor);
}

function applyUnityRenderPreset(presetId) {
    const preset = UNITY_RENDER_PRESETS[presetId];
    if (!preset) return;
    writeUnityRendererForm({
        ...readUnityRendererForm(),
        ...preset,
        pipelineAsset: presetId
    });
    updateRangeLabels();
    syncSaveButton();
}
...
function updateRangeLabels() {
    ...
    const unity = readUnityRendererForm();
    elements.unityRenderScaleValue.textContent = `${Math.round(unity.renderScale * 100)}%`;
    elements.unityShadowDistanceValue.textContent = `${unity.shadowDistance.toFixed(1)} m`;
    elements.unityPostExposureValue.textContent = unity.postExposure.toFixed(2);
    elements.unityContrastValue.textContent = `${Math.round(unity.contrast)}`;
    elements.unitySaturationValue.textContent = `${Math.round(unity.saturation)}`;
    elements.unityBloomIntensityValue.textContent = unity.bloomIntensity.toFixed(2);
    elements.unityMtoonOutlineWidthValue.textContent =
        `${Math.round(unity.mtoonOutlineWidthMultiplier * 100)}%`;
    elements.unityMtoonOutlineColorBlendValue.textContent =
        `${Math.round(unity.mtoonOutlineColorBlend * 100)}%`;
    elements.unityCameraFovValue.textContent = `${Math.round(unity.cameraFieldOfView)}°`;
    elements.unityCameraDistanceValue.textContent = unity.cameraDistance.toFixed(2);
    elements.unityCameraHeightValue.textContent = unity.cameraHeight.toFixed(2);
    elements.unityCameraTargetHeightValue.textContent = unity.cameraTargetHeight.toFixed(2);
    elements.unityCameraHorizontalOffsetValue.textContent = unity.cameraHorizontalOffset.toFixed(2);
    elements.unityFramingPaddingValue.textContent = `${Math.round(unity.framingPadding * 100)}%`;
    elements.unityFramingVerticalBiasValue.textContent = unity.framingVerticalBias.toFixed(2);
    elements.unityAmbientIntensityValue.textContent = unity.ambientIntensity.toFixed(2);
    elements.unityMainLightShadowStrengthValue.textContent = `${Math.round(unity.mainLightShadowStrength * 100)}%`;
    elements.unityKeyLightIntensityValue.textContent = unity.keyLightIntensity.toFixed(2);
    elements.unityKeyLightYawValue.textContent = `${Math.round(unity.keyLightYaw)}°`;
    elements.unityKeyLightPitchValue.textContent = `${Math.round(unity.keyLightPitch)}°`;
    elements.unityFillLightIntensityValue.textContent = unity.fillLightIntensity.toFixed(2);
    elements.unityRimLightIntensityValue.textContent = unity.rimLightIntensity.toFixed(2);
...
function normalizePreferences(preferences = {}) {
    ...
    return {
        ...
        characterRendererBackend: availableCharacterRendererBackends.includes(
            String(preferences.characterRendererBackend || '').trim().toLowerCase()
        )
            ? String(preferences.characterRendererBackend).trim().toLowerCase()
            : availableCharacterRendererBackends[0] || 'electron',
        characterRendererRuntime: preferences.characterRendererRuntime &&
            typeof preferences.characterRendererRuntime === 'object'
            ? preferences.characterRendererRuntime
            : {},
        ...
        unityRenderer: normalizeUnityRendererSettings(preferences.unityRenderer),
...
function readFormPreferences({ includeSecret = false } = {}) {
    ...
    const nextPreferences = normalizePreferences({
        ...
        characterRendererBackend: elements.characterRendererBackend?.value ||
            currentPreferences?.characterRendererBackend ||
            'electron',
        ...
        unityRenderer: readUnityRendererForm(),
...
function fillForm(preferences) {
    ...
    if (elements.characterRendererBackend) {
        elements.characterRendererBackend.value = normalized.characterRendererBackend;
    }
    syncRendererBackendPanels();
    renderCharacterRendererStatus(normalized.characterRendererRuntime, normalized.characterRendererBackend);
    ...
    writeUnityRendererForm(normalized.unityRenderer);
...
function fillCharacterRendererBackendOptions(backendOptions = []) {
    if (!elements.characterRendererBackend) {
        return;
    }
    const normalizedOptions = [...new Set(backendOptions
        .map((backend) => String(backend || '').trim().toLowerCase())
        .filter((backend) => backend === 'electron' || backend === 'unity'))];
    availableCharacterRendererBackends = normalizedOptions.length
        ? normalizedOptions
        : ['electron'];
    elements.characterRendererBackend.innerHTML = '';
    const labels = {
        electron: 'Electron / Three.js（轻量）',
        unity: 'Unity 高清渲染'
    };
    availableCharacterRendererBackends.forEach((backend) => {
        const option = document.createElement('option');
        option.value = backend;
        option.textContent = labels[backend] || backend;
        elements.characterRendererBackend.appendChild(option);
    });
    const field = document.getElementById('character-renderer-backend-field');
    if (field) {
        field.hidden = availableCharacterRendererBackends.length < 2;
    }
    if (!availableCharacterRendererBackends.includes('unity') && elements.unityRendererSettings) {
        elements.unityRendererSettings.hidden = true;
    }
}
...
function renderMemoryStrategyState(strategyState = {}, cognitionStatus = {}) {
    const select = elements.memoryStrategySelect;
    const strategies = Array.isArray(strategyState.strategies)
        ? strategyState.strategies
        : [];
    const active = String(strategyState.active || strategyState.status?.strategy || '');
    if (select) {
        select.innerHTML = '';
        ...
        select.disabled = !strategies.length;
    }
    if (elements.memoryStrategyStatusText) {
        const profile = strategies.find((strategy) => strategy.id === active) ||
            strategyState.status?.profile ||
            {};
        const cognition = profile.requiresCognition
            ? `认知单元 ${Number(cognitionStatus.activeUnitCount || 0)}，观察 ${Number(cognitionStatus.observationCount || 0)}，心智模型 ${Number(cognitionStatus.mentalModelCount || 0)}`
            : '不需要认知整理';
        const embedding = profile.requiresDense
            ? `语义检索 ${strategyState.status?.embedding?.runtime || '等待首次加载'}`
            : '纯稀疏/结构化检索';
        elements.memoryStrategyStatusText.textContent = [
            profile.description || '',
            cognition,
            embedding
        ].filter(Boolean).join(' | ');
    }
    if (elements.curateMemoryCognitionBtn) {
        const activeProfile = strategies.find((strategy) => strategy.id === active);
        elements.curateMemoryCognitionBtn.disabled =
            activeProfile?.requiresCognition !== true ||
            cognitionStatus.running === true;
    }
}
...
async function refreshMemoryStatus() {
    ...
    try {
        const [snapshot, strategyState, cognitionStatus] = await Promise.all([
            window.ailisDesktop.memory.getSnapshot({ includeEvents: false }),
            window.ailisDesktop.memory.getStrategies?.() || Promise.resolve({}),
            window.ailisDesktop.memory.getCognitionStatus?.() || Promise.resolve({})
        ]);
        renderMemorySnapshot(snapshot);
        renderMemoryStrategyState(strategyState, cognitionStatus);
    } catch (error) {
        if (elements.memoryStatusText) {
...
async function selectMemoryStrategy() {
    const strategy = String(elements.memoryStrategySelect?.value || '').trim();
    if (!strategy || !window.ailisDesktop?.memory?.setStrategy) {
        return;
    }
    elements.memoryStrategySelect.disabled = true;
    try {
        const result = await window.ailisDesktop.memory.setStrategy({ strategy });
        if (!result?.ok) {
            throw new Error(result?.status || 'memory_strategy_switch_failed');
        }
        await refreshMemoryStatus();
        setStatus(`AILIS 记忆方案已切换为 ${strategy}；原始记忆和 TaskAgent 未改动。`);
    } catch (error) {
        setStatus(`切换记忆方案失败：${error.message || error}`);
        await refreshMemoryStatus();
    }
}

async function curateMemoryCognition() {
    if (!window.ailisDesktop?.memory?.curateCognition) {
        setStatus('当前环境不支持认知记忆整理。');
        return;
    }
    elements.curateMemoryCognitionBtn.disabled = true;
    setStatus('正在从原始对话整理证据可追溯的认知记忆…');
    try {
        const result = await window.ailisDesktop.memory.curateCognition({
            maxBatches: 12
        });
        if (!result?.ok) {
            throw new Error(result?.error || result?.status || 'memory_cognition_curation_failed');
        }
        await refreshMemoryStatus();
        setStatus(
            result.status === 'no_new_raw_memory'
                ? '认知记忆已经是最新状态。'
                : `认知记忆整理完成：${result.status}。`
        );
    } catch (error) {
        setStatus(`认知记忆整理失败：${error.message || error}`);
        await refreshMemoryStatus();
    }
}
...
async function initialize() {
    ...
    try {
        const bootstrapPreferences = window.ailisDesktop?.preferences;
        if (bootstrapPreferences && Object.keys(bootstrapPreferences).length) {
            // Apply the tiny preload snapshot first so saved Unity users never
            // see the legacy Electron controls while the full panel loads.
            fillForm(bootstrapPreferences);
        }
        ...
        fillCharacterRendererBackendOptions(panelState.options?.characterRendererBackendOptions || ['electron']);
...
const unityRendererInputs = [
    elements.unityPipelineAsset,
    elements.unityTargetFrameRate,
    elements.unityRenderScale,
    elements.unityMsaaSampleCount,
    elements.unityAdaptiveSupersampling,
    elements.unityShadowDistance,
    elements.unityShadowCascadeCount,
    elements.unityCameraAntialiasing,
    elements.unityCameraAntialiasingQuality,
    elements.unityRenderPostProcessing,
    elements.unityPostExposure,
    elements.unityContrast,
    elements.unitySaturation,
    elements.unityBloomIntensity,
    elements.unityMtoonOutlineWidth,
    elements.unityMtoonOutlineColorBlend,
    elements.unityCameraFramingMode,
    elements.unityCameraFov,
    elements.unityCameraDistance,
    elements.unityCameraHeight,
    elements.unityCameraTargetHeight,
    elements.unityCameraHorizontalOffset,
    elements.unityFramingPadding,
    elements.unityFramingVerticalBias,
    elements.unityAmbientIntensity,
    elements.unityMainLightShadows,
    elements.unityMainLightShadowStrength,
    elements.unityKeyLightIntensity,
    elements.unityKeyLightYaw,
    elements.unityKeyLightPitch,
    elements.unityKeyLightColor,
    elements.unityFillLightIntensity,
    elements.unityFillLightColor,
    elements.unityRimLightIntensity,
    elements.unityRimLightColor
];
...
[
    ...
    elements.petScale,
    elements.characterRendererBackend,
    ...unityRendererInputs,
...
elements.characterRendererBackend?.addEventListener('change', syncRendererBackendPanels);
elements.unityPipelineAsset?.addEventListener('change', () => {
    applyUnityRenderPreset(elements.unityPipelineAsset.value);
});
...
elements.memoryStrategySelect?.addEventListener('change', () => {
    void selectMemoryStrategy();
});

elements.curateMemoryCognitionBtn?.addEventListener('click', () => {
    void curateMemoryCognition();
});
...
elements.openCharacterLabBtn?.addEventListener('click', () => {
    void window.ailisDesktop?.showCharacterLab?.();
});
