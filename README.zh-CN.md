...
| 指标 | AILIS P1 | **AILIS A6** | 原生 Codex |
| --- | ---: | ---: | ---: |
| 总分 | 54 / 165，32.73% | **102 / 165，61.82%** | **106 / 165，64.24%** |
| Level 1 | 24 / 53 | **38 / 53** | 42 / 53 |
| Level 2 | 28 / 86 | **50 / 86** | 56 / 86 |
| Level 3 | 2 / 26 | **14 / 26** | 8 / 26 |
| 有答案结果 | 165 / 165 | **165 / 165** | 161 / 165 |
| Gross tokens | 41.23M | **31.37M** | 69.06M |
| Effective tokens | 28.55M | **31.37M** | 8.18M |
| 平均 / P95 延迟 | 277.0s / 509.6s | **210.4s / 575.0s** | 255.9s / 584.7s |
| 逻辑工具调用 | 1,138 | **1,814** | 1,959 |
...
降低 24.0%。同模型的原生 Codex 为 106/165；A6 只少 4 题、相差 2.42 个
百分点，同时多给出 4 个答案，L3 为 14/26，高于 Codex 的 8/26。这里加入
Codex 对照，是为了说明 A6 相对业界通用 Agent runtime 所处的质量位置，不是
宣称官方 GAIA 排行榜成绩。
