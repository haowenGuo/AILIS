# AILIS Desktop Pet V1: From Web Avatar to Resident Companion

This iteration is important not because AILIS now runs inside Electron, but because it finally behaves like a desktop product instead of a browser demo inside a shell.

At this point, AILIS is no longer only a 3D character on a web page. She can stay on the desktop, open a chat window on demand, and respond with animation, expression, and speech-aware interaction.
...
That is the point where AILIS stops being only a character prototype and starts becoming a usable desktop companion.
...
The most accurate way to describe AILIS at this stage is no longer “a chat page.” It is becoming a lightweight virtual companion system in desktop-pet form:
...
The most valuable part of this iteration is that AILIS has crossed from prototype territory into something closer to a product.
